---
title: '[Quasar] 使用 Quasar CLI 建構 SSR 網站'
excerpt: '最近專案要從 SPA 改成 SSR，雖然一般而言 SSR 是在專案開發前或者開發初期就得考量，但是事情總有個萬一，俗話說的好，需求是會成長的嘛。好險 Quasar 也有提供建構 SSR 的方法，這對於轉換到 SSR 會減少許多麻煩。'
