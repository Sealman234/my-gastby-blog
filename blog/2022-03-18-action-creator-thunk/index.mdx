...
excerpt: '本文繼續介紹 Redux Toolkit 的使用方式，因為有 Action Creator Thunk 讓我真的特別愛用 Redux Toolkit ❤️'
tags: ['React', 'Redux', 'Redux Toolkit']
date: '2022-03-18'
---

## Problems with Asynchronous code in Redux

在元件中可處理非同步行為，而在 Reducer 中我們只處理同步行為。因為在 Reducer 執行 Call API 這種非同步的動作會造成 Side Effect，另外也不要在 Reducer 以外的地方 mutate 任何的 state。
