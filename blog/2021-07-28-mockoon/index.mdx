...
excerpt: '本文介紹如何用 Mockoon 快速建立 Mock APIs Server。'
tags: ['Mockoon']
date: '2021-07-28'
---
...
因為前後端架構的問題，身為前端需要自己研究開設假的本地 API，否則做個畫面都得問東問西的，開發效率低到谷底。

查了一下資料，發現大家幾乎都是用 JSON Server 居多，有些則是使用 Postman，就在我打算開始研究 JSON Server 時，看到了 [如何用 Mockoon 快速建立 Mock APIs Server](https://www.letswrite.tw/mockoon/) 這篇文章，看完就決定試試看 Mockoon，結果實際使用後覺得真的不錯，很簡單就能上手，這邊記錄一下操作方法。
