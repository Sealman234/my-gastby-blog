...
excerpt: "這個團隊一直在更新耶，才剛升級到第六版，現在又來了一次全面升級。但是不得不說，這次改版確實新增了許多功能，其中 Loader 是讓我最驚豔的功能，很值得給它升級上去，而且他們文件寫得很好，基本上 Tutorial 跟著操作一遍，就能掌握 V6 的大致功能了，這一點真希望 React 本體也能好好跟上。"
...
除了可以使用 Link 來換頁，我們也可以手動去執行路由跳轉的動作，例如在送出表單或按下按鈕後導頁。
